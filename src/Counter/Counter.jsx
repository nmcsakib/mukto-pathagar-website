...
import { homepageData } from "../contents/content";
  ...
  return (
    <section className="container mx-auto p-8 my-5">
      ...
      <div className="flexcode-container">
        <div className="rounded-xl py-16 px-5 md:px-0 text-center border-gray-500 transition-all duration-300 hover:border-[#33a037] border-2  grid gap-8 md:gap-0 md:grid-cols-3 justify-center text-stone-400 divide-y-2 md:divide-y-0 divide-x-0 md:divide-x-2 hover:divide-[#33a037] divide-gray-500 group">
          <div className="flex flex-col gap-2 md:gap-5 justify-center items-center">
            <h2 className="text-5xl md:text-7xl flex items-center gap-5 font-bold">
              ...
              <span className="-ml-4 group-hover:text-[#33a037] duration-300">
                {" "}
                &#43;
              </span>
            </h2>
